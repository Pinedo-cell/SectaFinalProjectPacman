...
#Here the total number of training steps must be 4000000, but at this point
#with this batch size, the error appear.


n_steps = 1553055 # total number of training steps
...
discount_rate = 0.99
skip_start = 9  # Skip the start of every game (it's just waiting time).
batch_size = 900
